    ...
    <div class="preview">
      <CollapsabileSection>
        <div class="preview-content">
          <div class="top-row">
            <img alt="" :src="selectedRobot.head.src"/>
          </div>
          <div class="middle-row">
            <img alt="" :src="selectedRobot.leftArm.src" class="rotate-left"/>
            <img alt="" :src="selectedRobot.torso.src"/>
            <img alt="" :src="selectedRobot.rightArm.src" class="rotate-right"/>
          </div>
          <div class="bottom-row">
            <img alt="" :src="selectedRobot.base.src"/>
          </div>
        </div>
      </CollapsabileSection>
...
export default {
  ...
  methods: {
    addToCart() {
      ...
      this.$store.commit('robots/addRobotToCart', { ...robot, cost });
